...
class OpenCVStuff(hardwareMap: HardwareMap) : Camera {
    private var targetRange: ColorRange = if(CameraGlobals.color == CameraGlobals.GlobalState.Red) ColorRange.RED
